...
static Color material_to_weights(BlockMaterial mat) {
    switch (mat) {
        ...
        case BlockMaterial::DIRT:   return Color(2, 0, 0, 0);
        case BlockMaterial::STONE:  return Color(3, 0, 0, 0);
        case BlockMaterial::SAND:   return Color(4, 0, 0, 0);
        case BlockMaterial::SNOW:   return Color(5, 0, 0, 0);
        case BlockMaterial::GRAVEL: return Color(6, 0, 0, 0);
...
void ChunkMeshGenerator::build(Ref<BlockLODSource> p_source, ChunkNode* p_chunk) {
